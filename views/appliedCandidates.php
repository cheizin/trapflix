...
<nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item active" aria-current="page">
            <i class="far fa-user-plus"></i> <b><?php echo $profile_pic['fName'];?> <?php echo $profile_pic['lName'];?> <?php echo $job_posted['job_title'];?> Application Details</b>
            <br/>
...
<div class="detail-wrapper">
  ...
  <div class="detail-wrapper-body">
    ...
    <br/>
      ...
      <p><?php echo $get_mail['cover_letter'];?> </p>
