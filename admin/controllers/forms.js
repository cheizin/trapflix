...
<div id="throbber">
    <img src="https://trapflix.com/admin/images/loader/VAyR.gif" />
</div>`;
...
$(document).on('submit','#user-donation-form', function(e){
  e.preventDefault();

  var form = $('#user-donation-form');
  //ajax request variables
  var form_method = 'POST';
  var form_data = form.serializeArray();
  var form_url = 'controllers/pesapal/pesapal-iframe.php';
...
$.ajax({
      ...
      beforeSend: function()
      {
        $('.donate-btn').block({ message: null });
      },
      success: function(data)
      {
        toastr.success('We are now loading the payment form...');
        $('.pesapal-iframe').html(data);
        $('.donate-btn').unblock();
        console.log(data);
    },
      error: function(xhr)
...
$(document).on("submit", "#test-login-form", function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            Toast.fire({
                icon: 'error',
                title: 'Your Account has been Deactivated. Contact Trapflix For Reactivation'
              });
            }
            else
            {
...
// Update the button text
btn.textContent = 'Uploading video Please Wait...';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Local Video Successfully Added'
                });
...
$(document).on("submit","#upload-picture-form", function(e){
    e.preventDefault();
...
// Update the button text
btn.textContent = 'Changing Picture Please Wait...';

    var form_url = 'controllers/video-management/upload_profile.php';
    var form_method = 'POST';
...
// Update the button text
btn.textContent = 'Creating Channel ...';
    var form_data = $(this).serializeArray();
...
// Update the button text
btn.textContent = 'Creating Category Feeds ...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/feeds/addCategory.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Feeds Category Created Successfully'
                });
...
// end add feeds category

// add feeds details
$(document).on("submit","#add-feeds-form", function(e){
    e.preventDefault();
...
// Update the button text
btn.textContent = 'Uploading feeds Please Wait...';
    var form_url = 'controllers/feeds/addFeeds.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Feeds Successfully Added'
                });
                $('#add-feeds-modal').modal('hide');
                $('body').removeClass('modal-open');
                $('.modal-backdrop').remove();
                $('.video-reordering-link').click();
...
// Update the button text
btn.textContent = 'Uploading youtube video Please Wait...';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Youtube Video Successfully Added'
                });
...
// temporary video compression all_pending_payments_form
$(document).on("submit","#compress-form", function(e){
    e.preventDefault();
...
// Update the button text
btn.textContent = 'Compressing images Please Wait...';
    var form_url = 'controllers/video-management/compress_link.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Image Compressed sucessfully'
                });
                $('#add-youtube-video-modal').modal('hide');
                $('body').removeClass('modal-open');
                $('.modal-backdrop').remove();
...
function ModifyBanner(str)
{

    var form_id = $('#edit-banner-form-'+str);
    ...
    var video_id = $('#video_id-'+str).val();

    var edit_banner = 'edit_banner';
    ...
    form_data.append('edit_banner',edit_banner);


    var form_url = 'controllers/popular/bannerVideoController.php';
    var form_method = 'POST';
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              $('.modal-backdrop').remove();
               ...
               Toast.fire({
                    icon: 'success',
                    title: 'Banner Video UPdated Successfully'
                  });

              $('.upload-banner-link').click();
            }
            else if(data == 'failed')
            {
             Toast.fire({
...
// rearrange videos
function ModifyVideo(str)
{

    var form_id = $('#reorder-video-form-'+str);
    ...
    var reorder_video = 'reorder_video';
    ...
    form_data.append('reorder_video',reorder_video);


    var form_url = 'controllers/video-management/videoReordering.php';
    var form_method = 'POST';
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              $('.modal-backdrop').remove();
               ...
               Toast.fire({
                    icon: 'success',
                    title: ' Video reordered Successfully'
                  });
...
function editChannel2(str)
{
    ...
    var form_url = 'controllers/channel-management/editChannel.php';
    var form_method = 'POST';
...
//start delete news feed

function deleteFeed(id) {

  Swal.fire({
      title: 'This Feed will be removed from the list',
      text: "Are you sure to proceed?",
      icon: 'Video',
      showCancelButton: true,
      confirmButtonText: 'YES, Delete',
      ...
      if (result.value) {
        ...
        var delete_feeds = 'delete_feeds';
        var form_data = {
          id:id,
          delete_feeds:delete_feeds
        };
        var form_url = 'controllers/delete/deleteFeeds.php';
        var form_method = 'POST';
...
//end popular video
//start make top channel
function makeTopChannel(id) {
        ...
        $.ajax({
            ...
            success:function(data){
              ...
              else
              {
                Swal.fire(
                  'NOT Made Top',
                  'Failed to MAke Top. Please try again',
                  'error'
                );
                console.log(data);
              }
...
function approveChannel(id) {
  ...
  Swal.fire({
      title: 'This Channel will be Approved',
      text: "Are you sure to proceed?",
      icon: 'Channel',
      showCancelButton: true,
      ...
      if (result.value) {
        ...
        var approve_channel = 'approve_channel';
        var form_data = {
          id:id,
          approve_channel:approve_channel
        };
   var form_url = 'controllers/channel-approvals/channelApproval.php';
        var form_method = 'POST';
...
// end approve
// remove top channel
function removeTopChannel(id) {

  Swal.fire({
      title: 'This Channel will be Removed from Top Channel',
      text: "Are you sure to proceed?",
      icon: 'Channel',
      showCancelButton: true,
      ...
      if (result.value) {
        ...
        var remove_top_channel = 'remove_top_channel';
        var form_data = {
          id:id,
          remove_top_channel:remove_top_channel
        };
      var form_url = 'controllers/popular/topChannelController.php';
        var form_method = 'POST';
...
function disapproveChannel(id) {

  Swal.fire({
      title: 'This Channel will be Disapproved and Not appear in the channel List',
      text: "Are you sure to proceed?",
      icon: 'Channel',
      showCancelButton: true,
      ...
      if (result.value) {
        ...
        var disapprove_channel = 'disapprove_channel';
        var form_data = {
          id:id,
          disapprove_channel:disapprove_channel
        };
      var form_url = 'controllers/channel-approvals/channelApproval.php';
        var form_method = 'POST';
...
// end channel disapproval

// remove top video
function removePopularVideo(id) {

  Swal.fire({
      title: 'This video will be Removed from Popular Channel',
      text: "Are you sure to proceed?",
      icon: 'Videos',
      showCancelButton: true,
      confirmButtonText: 'YES, Remove Popular',
      cancelButtonText: 'NO',
      reverseButtons: true
    }).then((result) => {
      if (result.value) {

        var remove_popular_Video = 'remove_popular_Video';
        var form_data = {
          id:id,
          remove_popular_Video:remove_popular_Video
        };
      var form_url = 'controllers/popular/popularVideoController.php';
        var form_method = 'POST';
...
function deactivateUser(id) {
  ...
  Swal.fire({
      ...
      var form_url = 'controllers/auth/deactivateUser.php';
        var form_method = 'POST';
...
function deactivateUser2(id) {

  Swal.fire({
      title: 'This account will be deactivated',
      text: "Are you sure to proceed?",
      icon: 'Videos',
      showCancelButton: true,
      confirmButtonText: 'YES, Deactivate',
      ...
      if (result.value) {
        ...
        var deactivateuser2 = 'deactivateuser2';
        var form_data = {
          id:id,
          deactivateuser2:deactivateuser2
        };
      var form_url = 'controllers/auth/admindeactivateUser.php';
        var form_method = 'POST';
...
//end admin deactivate user
// admin activate user

function activateUser2(id) {

  Swal.fire({
      title: 'This account will be Activated',
      text: "Are you sure to proceed?",
      icon: 'Videos',
      showCancelButton: true,
      ...
      if (result.value) {
        ...
        var activateuser2 = 'activateuser2';
        var form_data = {
          id:id,
          activateuser2:activateuser2
        };
      var form_url = 'controllers/auth/adminactivateUser.php';
        var form_method = 'POST';
...
function activateUser(id) {
  ...
  Swal.fire({
      ...
      var form_url = 'controllers/auth/activateUser.php';
        var form_method = 'POST';
