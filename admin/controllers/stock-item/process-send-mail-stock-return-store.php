...
The following Stock Item was returned in the store and recorded in the system by <b>".$recorded_by."</b> <br/
Stock Item Returned <b>".$item_name."</b><br/>End Product <b>".$product_name."</b><br/>Quantity Returned <b>".$qtt."</b>
<br/>Unit Price<b>".$unit_price."</b>
<br/>Total Cost of Stock Returned <b>".$total_stock."</b><br/>Supplier <b>".$supplier_name."</b><br/>
