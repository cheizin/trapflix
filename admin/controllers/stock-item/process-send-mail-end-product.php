...
End Product <b>".$item_name."</b><br/>Unit Price<b>".$unit_price."</b><br/>Production Quantity <b>".$qtt."</b><br/>Total Value<b>".$total."</b>
<br/>Project Name <b>".$customer_id."</b><br/>Project Start Date <b>".$product_start_date."</b><br/>
Project End Date <b>".$product_end_date."</b><br/>Project Duration<b>".$duration."</b><br/>
 has been added in the system by <b>".$recorded_by."</b> <br/>
<br/><br/><br/>
