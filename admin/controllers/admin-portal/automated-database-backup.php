...
define("DB_USER","root");
define("DB_PASS","Projects2018!");
define("DB_NAME","dev_projects");
...
$selected_location = mysqli_real_escape_string($dbc,strip_tags("C:\\Apache24\\pprmis_database_backups\\"));

$fileName = 'db-backup-'.date("d-m-Y-h-i-s-a").'-'.'.sql';

$fileName = $selected_location.$fileName;
$backup_location = $fileName;
$backup_type = "database";
$recorded_by = "Automated Script";
$time_recorded = date('Y/m/d H:i:s');

$sql_backup = mysqli_query($dbc,"INSERT INTO backups
                (backup_location,backup_type,triggered_by,time_recorded)
                    VALUES
            ('".$backup_location."','".$backup_type."','".$recorded_by."','".$time_recorded."')"
             );
...
$sql_log = mysqli_query($dbc,"INSERT INTO activity_logs
                (email,action_name,action_reference,action_icon,page_id,time_recorded)
                    VALUES
            ('".$recorded_by."','".$action_name."','".$action_reference."',
