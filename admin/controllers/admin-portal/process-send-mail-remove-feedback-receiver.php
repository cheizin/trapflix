...
{
  $email = mysqli_real_escape_string($dbc,strip_tags($_POST['sid'])); //feedback receiver
  ...
  $user = mysqli_fetch_array(mysqli_query($dbc,"SELECT Name FROM staff_users WHERE Email='".$email."'"));
      ...
      $message =  " Dear " .$user['Name']. ", <br/><br/>
                  ...
                  Your mail has been removed from receiving PPRMIS Users Feedback by : ".$_SESSION['name']." <br/><br/>
