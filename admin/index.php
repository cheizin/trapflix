...
$http_origin = "https://trapflix.risksys.co.ke/";
/*
...
<img src="https://trapflix.risksys.co.ke/images/profile/<?php echo $user_image['thumbnail'];?>" class="img-circle elevation-2" alt="User Image">
...
<img src="https://trapflix.risksys.co.ke/images/profile/avatar.png" class="img-circle elevation-2" alt="User Image">
              ...
              <a href="#" class="nav-link active" onclick="location.reload();">
                ...
                <p>
                  HOME
                               ...
                               <li class="nav-item mb-1">
              <a href="https://trapflix.risksys.co.ke/home.php" class="nav-link">
...
<!--
                   ...
                   -->
                     <li class="nav-item">
          <a href="https://trapflix.risksys.co.ke/orderChannel.php" class="nav-link">
              <i class="nav-icon fas fa-plus"></i>
                  ...
                  if($_SESSION['access_level'] == 'admin')
                  {
                   ...
                   <div class="row module-panel">
                       ...
                       <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              <li class="breadcrumb-item active" aria-current="page"><strong> <?php echo $total_users2;?></strong> TRAPFLIX Users</li>
...
<div class="row">
                     ...
                     if($total_rows = mysqli_num_rows($sql_query254) > 0)
                     {
                       ...
                       <img src="https://trapflix.risksys.co.ke/images/profile/<?php echo $user_image['thumbnail'];?>"
...
<?php
                     ...
                     else
                     {
                       ...
                       <img src="https://trapflix.risksys.co.ke/images/profile/avatar.png"
                       width="100" height="100"class="img-circle" alt="Clear here to Upload Your Profile Image" onClick="triggerClick()" id="profileDisplay">
                              ...
                              <div class="col-md-4 text-center">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                  <li class="list-group-item">
                                    <b>Trapflix ID:</b> <a class="float-right">TRAP<?php echo $row['id'] ;?></a>
                                  </li>
                                  <li class="list-group-item">
