    ...
    <div class="card card-primary card-outline">
      ...
      <div class="card-body table-responsive">
        ...
        {?>
         ...
         <?php
         $no = 1;
          $sql = mysqli_query($dbc,"SELECT * FROM videos ORDER BY id ");
...
<?php
 ...
 $milestone_name = mysqli_query($dbc,"SELECT * FROM popular_videos WHERE popular_video_id ='".$row['id']."'  && is_popular ='yes'")
 or die(mysqli_error($dbc));
 if(mysqli_num_rows($milestone_name) > 0){

?>

<a href="#" class="btn btn-link" data-toggle="tooltip" title="Click here to remove it from Popular List" onclick="removePopular('<?php echo $row['id'];?>');">
        ...
        else
{
  ...
  <a href="#" class="btn btn-link" data-toggle="tooltip" title="Click here to Make it Popular" onclick="makePopular('<?php echo $row['id'];?>');">
    <i class="fas fa-times text-danger"> Not Popular</i>
  </a>
