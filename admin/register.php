...
<head>
  ...
  <title id="current-title">Panorama | Inventory </title>
...
<div class="wrapper" style="border:0; padding:0;">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: rgb(2,100,176);">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="#"  style="background-color: rgb(2,100,176);" class="brand-link" data-toggle="tooltip" data-placement="bottom" title="Projects, Performance & Risk Management Information System">
      <img src="assets/img/inventory.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light"><b>Panorama Inventory</b></span>
    </a>
                 ...
                 <div class="card animated slideInLeft">
                   <form id="inventory-signup-form">
                       <div class="card-header bg-light">
                         Panorama Inventory Change Password
                       </div>
                       <div class="card-body">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; <?php echo date("Y");?> <a href="https://https://www.panoramaengineering.com/" target="_blank">Panorama Technical Services</a>.</strong>
    All rights reserved.
