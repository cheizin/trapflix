...
?>
  <div class="col-md-12">
    <div class="card">
      <div class="card-header bg-light">New Delivery</div>
            ...
            <tr id="new_row-<?php echo $risk['id'] ;?>">
              ...
              <td>
                   ...
                   <div class="col-md-4 mb-4">
                     <form id="approve-new-delivery-form-<?php echo $risk['id'];?>">

                       <input type="hidden" name="new_approval_value" id="new_approval_value-<?php echo $risk['id'] ;?>" value="approved">

                       <input type="hidden" name="new_reference_no" value="<?php echo $risk['id'];?>" id="new_reference_no-<?php echo $risk['id'];?>">

                       <button class="btn btn-success" style="width:150px;" data-toggle="tooltip" title="Please click the product Name for more
                          description before approving " id="approve-new-risk-button-<?php echo $risk['id'] ;?>"
                          onclick="approveNewDelivery(<?php echo $risk['id'];?>)"><i class="far fa-check-circle"></i> Approve</button>
                     </form>
                    </div>
