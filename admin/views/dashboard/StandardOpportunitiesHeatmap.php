<div class="row">
  <div class="col-md-8">
    <div class="card">
      <div class="card-header bg-light">Top 10 Departmental Opportunities (<span class="text-info"><?php echo $select_period .','.$select_quarter;?></span>)</div>
      <div class="card-body">
                 ...
                 <td class="medium" style="background-color: #59b4e0;"  title="OVERALL SCORE: 5">
                    <?php
                       $sql = mysqli_query($dbc,"SELECT * FROM update_risk_status
                                                  ...
                                                  && risk_opportunity='opportunity'  && period_from='".$select_period."' && quarter='".$select_quarter."' && risk_status='open' ORDER BY current_overall_score DESC LIMIT 10 ");
      ...
      <div class="card-body">
        <?php
           $sql_query = mysqli_query($dbc,"SELECT * FROM update_risk_status WHERE dep_code='".$_SESSION['department_code']."'
                                                     && risk_opportunity='opportunity' && changed='no'  && period_from='".$select_period."'
