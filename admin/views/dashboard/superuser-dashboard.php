...
<ul class="nav nav-fill nav-tabs" id="myTab" role="tablist">
  ...
  <li class="nav-item">
    <a class="nav-link power_bi_tab" data-toggle="tab" href="#powerBi_tab" role="tab"> <i class="far fa-chart-network"></i> Data Visualisation</a>
  </li>
  <li class="nav-item">
...
<div class="tab-content">
  <div class="tab-pane fade show active" id="risks_heatmap_tab" role="tabpanel"><?php include("CorporateRisksHeatmap.php");?></div>
