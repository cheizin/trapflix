...
if($_SESSION['access_level'] == "superuser" || $_SESSION['access_level'] == "admin" || $_SESSION['access_level'] == "director")
{
      ...
      <div class="col-xs-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">All Updated Risks</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body table-responsive no-padding">
              <table width="100%" class="table table-hover" id="analysis-all-risks-table">
                <thead>
                  <tr>
                    <td>NO</td>
                    <td>Department</td>
  ...
  else
  {
    ...
    <div class="alert alert-warning">
      <strong><i class="fa fa-info-circle"></i> No Updated Risks Found</strong>
    </div>
    <?php
  }
}
    ...
    ?>
      <div class="col-xs-12">
        <div class="card">
          ...
          <!-- /.card-header -->
          <div class="card-body table-responsive no-padding">
              <table class="table table-hover" id="analysis-all-risks-table"  width="100%">
                <thead>
                  <tr>
                    <td>NO</td>
                    <td>Risk Description</td>
