...
{
  $sql = mysqli_query($dbc,"SELECT * FROM pm_activity_updates");
  ...
  else
  {
    ...
    <div class="alert alert-warning">
      <strong><i class="fa fa-info-circle"></i> No Downgraded Risks Found</strong>
    </div>
    <?php
  }
}
else
{
  ...
  if(mysqli_num_rows($sql) > 0)
  {
    ...
    ?>
      <div class="col-xs-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Downgraded Risks</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body table-responsive no-padding">
              <table class="table table-hover" id="analysis-downgraded-risks-table" width="100%">
                <thead>
                  <tr>
                    <td>NO</td>
  ...
  else
  {
    ...
    <br/>
    <div class="alert alert-warning">
      <strong><i class="fa fa-info-circle"></i> No Task</strong>
    </div>
    <?php
  }
}
