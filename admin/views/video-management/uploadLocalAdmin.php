  ...
  <div class="col-lg-12 col-xs-12">
    <div class="card card-primary card-outline">
      ...
      <div class="card-body table-responsive">
        ...
        <?php
        $sql_query1 =  mysqli_query($dbc,"SELECT * FROM videos WHERE youtube_vid!='youtube' ORDER BY id ");
         ...
         <tr style="cursor: pointer;">
           ...
           <td>
             <?php
                ...
                <td>    <a href="https://trapflix.com/images/favorite/<?php echo $row['thumbnail'];?>" target="_blank">
               ...
               <?php echo $row['thumbnail'];?>
                ...
                <td>    <a href="https://trapflix.com/videos/<?php echo $row['videoname'];?>" target="_blank">
