...
<nav aria-label="breadcrumb">
     <ol class="breadcrumb">
       <li class="breadcrumb-item active" aria-current="page">Popular Video Management</li>
     </ol>
</nav>
  ...
  <div class="col-lg-12 col-xs-12">
    <div class="card card-primary card-outline">
      ...
      <div class="card-body table-responsive">
        ...
        <?php
        $sql_query1 =  mysqli_query($dbc,"SELECT * FROM videos ORDER BY id DESC");
        ...
        {?>
         ...
         <?php
         $no = 1;
          $sql = mysqli_query($dbc,"SELECT * FROM videos ORDER BY id DESC");
...
<?php
 ...
 $milestone_name = mysqli_query($dbc,"SELECT * FROM popular_videos WHERE popular_video_id ='".$row['id']."'") or die(mysqli_error($dbc));
 if(mysqli_num_rows($milestone_name) > 0){

?>

<a href="#" class="btn btn-link" data-toggle="tooltip" title="Click here to remove it from Popular List" onclick="removePopularVideo('<?php echo $row['id'];?>');">
  <i class="fas fa-check text-success"> IS Popular</i>
</a>
...
{
  ?>
  <a href="#" class="btn btn-link" data-toggle="tooltip" title="Click here to Make it Popular" onclick="makePopular('<?php echo $row['id'];?>');">
    <i class="fas fa-times text-danger"> Make Popular</i>
  </a>
...
<strong><i class="fa fa-info-circle"></i> No Popular videos</strong>
</div>
