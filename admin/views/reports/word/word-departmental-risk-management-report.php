...
require_once('../../../assets/libs/phpdocx/classes/CreateDocx.php');
...
<body>
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
    ...
    ?>
         ...
         <h1 style="text-align:center; background-image:url('https://pprmis.cma.or.ke/prmis/dist/img/cmapicture.jpg')">
          <?php echo $select_department ;?> <br/>
          Performance Risk Management Report Quarter ended <?php echo $select_quarter .', '.$select_period ;?>
         </h1>
    ...
    <?php
      ...
      if($sql)
      {
       ...
       <!-- start departmental activities with  risks -->
            <h3>Detailed Activities With Risks</h3>
...
if($sql_heatmap_row > 0)
{
 ?>
  <!-- start risk analysis -->
  <h4>RISK ANALYSIS<br/>Overview</h4>
      <table class="heatmap-table" style="width:50%; float:left;">
         <tr>
  ...
  <?php
   ...
   {?>
     <table style="overflow:wrap;width:40%; float:right;">
         <thead>
           <tr>
             <td>No</td>
             <td>Risk</td>
