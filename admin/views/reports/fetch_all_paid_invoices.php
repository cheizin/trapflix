 ...
 if (!isset($_SESSION['email']))
 {
  ...
  $row_end_date = mysqli_real_escape_string($dbc,strip_tags($_POST['product_end_date']));
    ...
    $sql = mysqli_query($dbc,
                            "SELECT * FROM invoice_received WHERE date_recorded BETWEEN '".$row_start_date."' AND '".$row_end_date."' && id IN
    ...
    <div class="card">
     ...
     <div class="card-body">
        <div class="table-responsive">
          <table class="table table-striped table-bordered table-hover" id="paid_invoices_report" style="width:100%">
            <thead>
              <tr>
                <td>#</td>
                <td>Stock Name</td>
