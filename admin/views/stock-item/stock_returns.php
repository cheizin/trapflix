  ...
  <div class="card card-primary card-outline">
    <div class="card-header">
      ...
      <button class="btn btn-link" style="float:right;"
              ...
              <i class="fa fa-exchange"></i> Return Stock <b> <?php echo $stock['item_name'] ;?></b> To the Store
      </button>
    </div>
...
<strong><i class="fa fa-info-circle"></i> No returns have been made To the Store</strong>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header alert alert-primary">
        ...
        <h5 class="modal-title">Stock <strong><?php echo $stock['item_name'] ;?></strong> Return to The Store
            ...
            <?php
                ...
                ?>
               <input type="text"  class="select2 form-control previous_stock_requested"  value ="<?php echo $single_product['qtt'];?>" name="qtt" readonly>

                    </div>
                    <div class="col-lg-3 col-xs-12 form-group">
                      <label>New Request</label>
                         <input type="text"  class="select2 form-control new_request"  name="qtt" readonly>
                      </div>
                  <div class="col-lg-3 col-xs-12 form-group">
      ...
      <div class="modal-body">
        <form id="return-single-end-product-form">
          ...
          <input type="hidden" name="add-returns-end-product" value="add-returns-end-product">
