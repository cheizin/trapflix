  ...
  <div class="card card-primary card-outline">
    <div class="card-header">
      ...
      <button class="btn btn-link" style="float:right;"
              data-toggle="modal" data-target="#add-supplier-modal">
     ...
     <table class="table table-striped table-bordered table-hover" id="end-product-table" style="width:100%">
       ...
       <?php
        ...
        <?php
          ...
          {
            ?>
            <span class="badge badge-success"  style="cursor: pointer;" title="Supplier Active, Click to deactivate" onclick="ChangeSupplierStatus('<?php echo $product['id'];?>','not_active');">Active</span>
            <?php
          }
          else
          {
            ?>
            <span class="badge badge-danger"  style="cursor: pointer;"  title="Supplier Not Active, Click to Activate" onclick="ChangeSupplierStatus('<?php echo $product['id'];?>','Active');">Not Active</span>
            <?php
          }
         ...
         ?>
              ...
              <!--
              <td>
            <a class="" href="#" data-toggle="modal" data-target="#edit-project-lesson-modal-<?php echo $product['id'] ;?>">
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title">Modifying Supplier
                       <span class="font-weight-bold"><?php echo $product['supplier_name'];?></h5>
                  ...
                  <div class="modal-body">
                      ...
                      <form id="edit-supplier-form-<?php echo $product['id'];?>"
                        onsubmit="supplierEdit('<?php echo $product['id'];?>');"
                        class="mt-4" enctype="multipart/form-data">
                      <!-- start of row
                      <div class="row">
                          <div class="col-lg-4 col-xs-12 form-group">
                              <label><span class="required">*</span>Supplier Name</label>
                              <input type="text" id="supplier_name-<?php echo $product['id'];?>" class="form-control" value ="<?php echo $product['supplier_name'];?>" required>
                          ...
                          <div class="col-lg-4 col-xs-12 form-group">
                              ...
                              <input type="text" id="contact-<?php echo $product['id'];?>" class="form-control" value ="<?php echo $product['contact'];?>" required>
                          </div>

                          <div class="col-lg-4 col-xs-12 form-group">
                              <label><span class="required">*</span>Email</label>
                              <input type="email" id="email-<?php echo $product['id'];?>" class="form-control" value ="<?php echo $product['email'];?>" required>
                          </div>
                          ...
                          <div class="col-lg-4 col-xs-12 form-group">
                           ...
                           ?>
                           <select id="sector-<?php echo $product['id'];?>"  class="select2 form-control">
                             <option value="<?php echo $product['sector'];?>" selected><?php echo $product['sector'];?></option>

                           <?php
                           while($row_result = mysqli_fetch_array($result)) {
                               ?><option value="<?php echo $row_result['id'];?>"><?php echo $row_result['sector'];?></option><?php
                           }
                           ?>
                           </select>
                       </div>
...
<strong><i class="fa fa-info-circle"></i> No Supplier List Exist</strong>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header alert alert-primary">
        ...
        <h5 class="modal-title">Adding supplier Details
      ...
      <div class="modal-body">
        <form id="add-supplier-list-form">
          ...
          <input type="hidden" name="add-supplier-list" value="add-supplier-list">
