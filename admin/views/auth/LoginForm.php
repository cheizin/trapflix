...
<div class="row">
  ...
  <div class="lockscreen-wrapper animated slideInLeft card card-body card-primary card-outline" style="max-width: 25rem;background-color: rgb(233, 236, 239); opacity:0.7">
  <!-- User name -->
