(function(global) {
    global.$_Tawk_AccountKey = '5c6d079177e0730ce043d509';
    ...
    (function(global) {
        global.$_Tawk.widgetSettings = {
            ...
            "bbl": {
                "name": "5c6d079177e0730ce043d509/var/chat_bubble/e29cf047ecaea1e08db7f9cb308fd53c9c89ac47",
                "type": "upload",
                "txt": "gallery",
                "bgc": "#7fb06f",
                "fgc": "#ffffff",
            ...
            "onlineGreeting": {
                ...
                "shortMessage": "Online",
                "longMessage": "Offering assistance is our priority. Kindly send a message for any system assistance.\n"
            },
            "awayGreeting": {
                "shortMessage": "Away",
                "longMessage": ""
            ...
            return function e(p, q, h) {
                ...
                6: [function(e, p, q) {
                    (function(h) {
                        ...
                        var e = h.BlobBuilder || h.WebKitBlobBuilder || h.MSBlobBuilder || h.MozBlobBuilder,
                            q;
                        try {
                ...
                8: [function(e, p, q) {
                    ...
                    h.prototype.emit = function(h) {
                        ...
                        var l = [].slice.call(arguments, 1),
                            g = this._callbacks[h];
                        if (g)
                            for (var g = g.slice(0), e = 0, p = g.length; e < p; ++e) g[e].apply(this, l);
                        return this
                    };
                ...
                12: [function(e, p, q) {
                    (function(h) {
                        ...
                        var l = e("./transports"),
                            g = e("component-emitter"),
                            q =
                            e("debug")("engine.io-client:socket"),
                            x = e("indexof"),
                            b = e("engine.io-parser"),
                            t = e("parseuri"),
                            I = e("parsejson"),
                            v = e("parseqs");
                        p.exports = m;
                                ...
                                y || (q('probe transport "%s" opened', b), G.send([{
                                    ...
                                    G.once("packet", function(f) {
                                        y || ("pong" == f.type && "probe" == f.data ? (q('probe transport "%s" pong', b), x.upgrading = !0, x.emit("upgrading", G), G && (m.priorWebsocketSuccess = "websocket" == G.name, q('pausing current transport "%s"', x.transport.name), x.transport.pause(function() {
                                            y || "closed" == x.readyState || (q("changing transport and sending upgrade packet"), v(), x.setTransport(G), G.send([{
                                                type: "upgrade"
                                            }]), x.emit("upgrade", G), G = null, x.upgrading = !1, x.flush())
                        ...
                        g.prototype.create = function() {
                            ...
                            try {
                                ...
                                this.hasXDR() ? (e.onload = function() {
                                    ...
                                    if (4 == e.readyState)
                                        if (200 == e.status || 1223 == e.status) l.onLoad();
                ...
                17: [function(e, p, q) {
                    ...
                    var m = e("../transport"),
                        l = e("parseqs"),
                        g = e("engine.io-parser");
                    q = e("component-inherit");
                    var V =
                        e("yeast"),
                        x = e("debug")("engine.io-client:polling");
                    p.exports = h;
                    var b = null != (new(e("xmlhttprequest-ssl"))({
                        xdomain: !1
                    })).responseType;
                    q(h, m);
                ...
                18: [function(e, p, q) {
                    (function(h) {
                        ...
                        var l = e("../transport"),
                            g = e("engine.io-parser"),
                            q = e("parseqs"),
                            x = e("component-inherit"),
                            b = e("yeast"),
                            t = e("debug")("engine.io-client:websocket"),
                ...
                20: [function(e, p, q) {
                    (function(h) {
                        ...
                        var g = e("./keys"),
                            p = e("has-binary"),
                            x = e("arraybuffer.slice"),
                            b = e("base64-arraybuffer"),
                            t = e("after"),
                            I = e("utf8"),
                        ...
                        q.decodePayload = function(b, g, h) {
                            ...
                            if ("" == b) return h(N, 0, 1);
                            e = "";
                            for (var l, m, f = 0, p = b.length; f < p; f++)
                                if (m = b.charAt(f), ":" != m) e += m;
                                else {
                            ...
                            function g(e) {
                                ...
                                if (m(e))
                                    for (var l = 0; l < e.length; l++) {
                                        ...
                                        for (l in e.toJSON && (e = e.toJSON()), e)
                ...
                28: [function(e, p, q) {
                    ...
                    p.exports = function(e) {
                        var g = e,
                            p = e.indexOf("["),
                            q = e.indexOf("]"); - 1 != p && -1 != q && (e = e.substring(0, p) + e.substring(p, q).replace(/:/g, ";") + e.substring(q, e.length));
                        e = h.exec(e || "");
                        for (var b = {}, t = 14; t--;) b[m[t]] = e[t] || ""; - 1 != p && -1 != q && (b.source = g, b.host = b.host.substring(1, b.host.length - 1).replace(/;/g, ":"), b.authority = b.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), b.ipv6uri = !0);
                        return b
                    }
                }, {}],
                29: [function(e, p, q) {
    ...
    (function(u) {
        ...
        u.prototype.listeners = function(p) {
            ...
            e(this._events[p]) || (this._events[p] = [this._events[p]]);
    ...
    (function(u) {
        ...
        try {
            ...
            var t = {
                    ...
                    "chat-resend-link": '<a id="resendMessage-__MESSAGE_ID__" href="https://risksys.co.ke/risksys/" class="messageStatus" title="Resend">__NOT_DELIVERED__</a><span class="icon-alert"></span> <span class="failed-label">__FAILED__</span>',
                    ...
                    "default-branding": '<span class="thin" onclick="javascript:location.href="https://risksys.co.ke/risksys/"">Powered by <b>Risksys Soft LTD</b> </span>',
            ...
            (function(a) {
                ...
                function b(a) {
                    for (var c = [], d = 0, k = a.length, s, f; d < k;) s = a.charCodeAt(d++), 55296 <= s && 56319 >= s && d < k ? (f = a.charCodeAt(d++), 56320 == (f & 64512) ? c.push(((s & 1023) << 10) + (f & 1023) + 65536) : (c.push(s), d--)) : c.push(s);
                    return c
                }

                function k(a) {
                    var c, k, q, r, y, u, z, A, B, C = [],
                        D, Ca, Ba;
                    a = b(a);
                    D = a.length;
                    c = m;
            ...
            var aa = function() {
                l = {
                    ...
                    dispatch: function(a, c) {
                        var d;
                        a && (d = "function" === typeof g.CustomEvent ? new CustomEvent(a, {
                            detail: c
            ...
            A.prototype.getReloadedScript = function() {
                var a, c, b = document.getElementsByTagName("script"),
                    k = null;
                a = 0;
            ...
            A.prototype.computedStyle = function(a, c) {
                var b;
                if (!a || !c) return null;
                if (a.currentStyle) b = a.currentStyle[c];
                else try {
            ...
            A.prototype.formatFileSize = function(a) {
                ...
                for (var b = 1; b < c.length; b++)
                    if (a < Math.pow(1024, b)) return Math.round(100 * (a / Math.pow(1024, b - 1))) / 100 + c[b - 1];
                return a
            };
            ...
            A.prototype.h = function(a) {
                ...
                for (var b = 0; b < a.length; b++) var k = a.charCodeAt(b),
                    c = (c << 5) - c + k,
                    c = c & c;
                return c
            };
            ...
            ca.prototype.searchString = function(a) {
                ...
                for (b = 0; b < a.length; b++)
                    if (d = a[b].string, k = RegExp(a[b].subString), this.versionSearchString = a[b].versionSearch || a[b].identity, k.test(d)) return a[b].identity
            };
            ...
            ka.prototype.listen = function(a, b, d, k) {
                ...
                if (k) {
                    ...
                    if (a.addEventListener) a.addEventListener(b, d, this.supportsPassive ? {
                        passive: !1
                    } : !1);
            ...
            var Da, H, xa, Ea, ta = 0,
                ...
                Wa = function(a, c) {
                    ...
                    if (s = "max" !== r.chatWindowState() && b.viewHandler.messagePreview ? b.viewHandler.messagePreview.container.getElementById("tab-content") : y && f.isPopup ? b.viewHandler.chatContainer.getElementById("tab-content") : e.container.getElementById("tab-content")) {
                                ...
                                if ((a = y && f.isPopup ? b.viewHandler.chatContainer.getElementById("search-list") : e.container.getElementById("search-list")) && Ea) {
                                    if (c)
                                        for (var s = 0; s < Ea.length; s++) {
                                            var g = Ea[s]; - 1 !== g.indexOf(c) && (k += d.replace(/__IMAGE__/, H.shortnameToImage(g)).replace(/__SHORTNAME__/g,
                                                g))
                                        }
                                    a.innerHTML = k;
                                    Xa()
                        ...
                        else if (k = Sa[d]) k.content.forEach(function(a) {
            ...
            ua.prototype.init = function() {
                ...
                this.socket.on("error", function(a) {
                    ...
                    if (a instanceof Error) {
                        ...
                        "TransportError" === a.type && (d.description = a.description); - 1 !== d.toString.indexOf("post") && (f = "socket post error")
                    } else d = a;
            ...
            C.prototype.insertCssFile = function(a, c) {
                var d = this.documentRef.getElementsByTagName("head")[0],
                    ...
                    f = n.createElement(this.documentRef, "style", {
                        type: "text/css"
                    }),
            ...
            Y.prototype.generateDynamicFields = function() {
                for (var a = "", b = RegExp("__LABEL__", "gm"), d = RegExp("__ID__", "gm"), k = RegExp("__MAXLENGTH__", "gm"), f = 0, e = this.formData.dynamicFields.length; f < e; f++) {
                    var g, h = "",
                        n = this.formData.dynamicFields[f];
                    if ("name" === n.fieldType || "email" === n.fieldType || "phone" === n.fieldType || "inputText" === n.fieldType) g = t.inputTextFieldType, g = "email" === n.fieldType ? g.replace("__INPUT_TYPE__",
                        "email") : g.replace("__INPUT_TYPE__", "text");
                    else if ("message" === n.fieldType || "textArea" === n.fieldType) g = t.textAreaFieldType;
                    else if ("department" === n.fieldType) g = t.departmentSelection;
            ...
            Y.prototype.addPlaceholderHandler = function() {
                var a, b;
                if (!ga)
                    for (var d = 0, k = this.formData.dynamicFields.length; d < k; d++) b = this.formData.dynamicFields[d], "department" !== b.fieldType && ("choice" !== b.fieldType && "option" !== b.fieldType) && (this.formData.dynamicFields[d].placeholderText = (b.isRequired ? "* " : "") + b.label, a = this.documentRef.getElementById(b.fieldName +
                    ...
                    on: function() {
                        !this.interval &&
                            f.showUnreadInTab() && (this.interval = setInterval(function() {
                                document.title = c.originalPageTitle === document.title ? b.languageParser.translate("chat", "newMessage", {
                                    num: c.unansweredMessages
                                }) : c.originalPageTitle
                            }, 1E3))
                    },
                    off: function() {
            ...
            E.prototype.toggleUploadsAction = function() {
                var a =
                    this,
                    c = this.container.documentRef.getElementById("uploadFileOption"),
                ...
                c && (f.showUploads() ? (c.style.display = "block", this.container.attachUserEventListener("change", function(c) {
                    ...
                    if (c && c.length) {
                        ...
                        if ((c = (a.originalEvent || a).clipboardData) && (c = c.items) && c.length) {
                            for (var f = 0; f < c.length; f++)
                                if (-1 !== c[f].type.indexOf("image")) {
                                    var e = c[f].getAsFile();
                                    if (null !== e) {
                                        d = e;
                                        d.name = b.languageParser.translate("chat", "pasted_image_title", {
                    ...
                    a.preventDefault();
                    a.stopPropagation && a.stopPropagation(); - 1 === d.className.indexOf(" drag-over") && n.addClass(d, "drag-over")
            ...
            E.prototype.toggleRatingAction = function() {
                var a = this.container.getElementById("rateMainWrapper"),
                    c = this.container.getElementById("rateContainer");
            ...
            E.prototype.appendCallInfo = function(a) {
                if (!y) {
                    var c, d, k = t["messagePreview-callInfo"],
                        s = a.callId,
                        e = a.caller;
                    a = a.isMissed;
                    var g = null,
            ...
            E.prototype.parseSurvey = function(a, b) {
                var d, k, f, e, g, h, l = a.match(n.regSurvey),
                    m = "";
                if (!l) return {
                    message: a,
                    isSurvey: !1
            ...
            E.prototype.limitMessageLength = function(a, b) {
                ...
                if (a.length > b)
                    for (d = 0; d < b;)
                        if ('<img class="emojione"' === a.substring(d, d + 21) || '<a target="_blank"' === a.substring(d, d + 18))
                            for (var k = d; k < a.length; k++) {
            ...
            E.prototype.removeElement = function(a) {
                for (var b = null, d = null, k = 0; k < this.timeIntervalsArr.length; k++)
                    ...
                    if (f.isTopPositioned())
                        for (k = d.length - 2; k < d.length; k--) {
                            ...
                            for (k = 1; k < d.length; k++)
                                if (b = d[k], b.getAttribute("data-uid") === a.getAttribute("data-uid")) {
                                    b.className = b.className.replace(/hidden-profile/gi, "");
                                    break
            ...
            E.prototype.resizeTextArea = function() {
                ...
                y || (this.resizeThrottle = setTimeout(function() {
                    var b = a.chatTextarea.elementReferrer.value,
                        d = a.container.documentRef.getElementById("actionsContainer"),
            ...
            var z = TawkClass.extend({
                ...
                appendAgent: function(a) {
                    ...
                    e && (c && l) && (-1 < this.chatContainer.getElementById("greetingsMainContainer").className.indexOf("minimize") && (g.style.display = "none", c.className = "show"), b.agents.agentsCount++, 1 < b.agents.agentsCount || 1 === b.agents.agentsCount && this.mainAgent && this.mainAgent.pid !== a.pid ? d.classList.remove("one-agent") : d.classList.add("one-agent"), 1 === b.agents.agentsCount ? (this.mainAgent = a, b.viewHandler.renderAgentHeader(a.pid), this.renderAgentMinimizedWidget(a.pid)) : (b.viewHandler.renderAgentHeader(a.pid), k.classList.add("multiple-agent")),
                        b.viewHandler.openAgentList(), c = t["agent-profile"], d = t["agent-profile-image"], k = t["agent-profile-description"], e = new C("agentProfile-" + a.pid, null, {
                            className: "agentWrapper clearfix"
                        }, null, e.documentRef), (g = a.pi ? r.agentImgUrl + "/" + a.pi : "") && (h = "background-image : url('" + g + "'); background-position : 0px 0px;"), h += "box-shadow: 0px 0px 0px 1px " + f.headerTxtColor + ";", k = n.escapeTemplateReplacement(k, [{
                ...
                removeAgent: function(a) {
                    var c, d, k, f, g = e.container.elementReferrer ? e.container : null,
                ...
                handleAcknowledgment: function(a) {
                    ...
                    if (m && a.messageId && (f = m.getElementById(a.messageId))) {
                        ...
                        for (var p = f.childNodes.length; d < p; d++) {
                            var q = f.childNodes[d]; - 1 !== q.className.indexOf("messageBody") && (c = n.getElementsByClassName(q, "messageWrapper"), l = n.getElementsByClassName(q, "messageStatusContainer"))
                        }
            ...
            z.prototype.addProfileDetail = function(a) {
                ...
                a.pi || 1 < b.agents.agentsCount ? (c = new C("profileDetail", null, null, null, this.chatContainer.documentRef),
                    k = t["agent-profile-description"], c.template = n.escapeTemplateReplacement(k, [{
                        ...
                        placeholder: "__NAME__",
                        textReplace: a.n
                    }])) : (c = new C("profileDetailNoImage", null, {
                    className: "noImageAgentProfileDetail"
                }, null, this.chatContainer.documentRef), d = a.pst ? "&nbsp-&nbsp" + a.pst : "", k = t["agent-profile-description-noimage"], c.template = n.escapeTemplateReplacement(k, [{
                    placeholder: "__POSITION__",
                    textReplace: d
                }, {
                    placeholder: "__NAME__",
            ...
            z.prototype.renderAgentWithPosition = function(a) {
                ...
                b && (f && a) && (a = w.agentProfiles[a], b = new C("profileDetail" + a.pid, null, {
                    className: "agent-profile-detailed theme-background-color"
                }, null, b.documentRef), d = a.pst ? a.pst : "", k = t["agent-profile-detailed"], b.template = n.escapeTemplateReplacement(k, [{
                    placeholder: "__POSITION__",
                    textReplace: d
                }, {
                    placeholder: "__NAME__",
            ...
            z.prototype.renderAgentHeader = function(a) {
                ...
                e && (g && a) && (c = w.agentProfiles[a], (d = c.pi ? r.agentImgUrl + "/" + c.pi : "") && (k = "background-image : url('" + d + "'); background-position : 0px 0px;z-index: " + (7 - b.agents.agentsCount) + ";"), k += "box-shadow: 0px 0px 0px 1px " + f.headerTxtColor + ";", c = new C("profileImage-" + c.pid, k, {
            ...
            z.prototype.appendAgentIsTypingElement = function(a) {
                var b, d, k = this.ifScrollbarDown(),
                    f = w.agentProfiles[a];
            ...
            z.prototype.parseUploadedFile = function(a) {
                var c = "https://tawk.link/" + a.name,
                    d = this,
                    k = t["file-upload"],
                    f = this.ifScrollbarDown();
                if (-1 !== ["jpeg", "png", "gif"].indexOf(a.type) && 2E6 >= a.size) {
                    var e = new Image;
                    e.onload = function() {
                        var k = n.createElement(d.chatContainer.documentRef, "a", {
                                href: c,
                                target: "_blank"
                            }),
                        ...
                        if (h) {
                            ...
                            if (!b.viewHandler.isMaximized && d.messagePreview) {
                                l = n.createElement(d.messagePreview.container.documentRef, "a", {
                                    href: c,
                                    target: "_blank"
                                });
            ...
            z.prototype.startUpload = function(a) {
                ...
                d = n.getElementsByClassName(f.chatContainer.elementReferrer,
                    "upload-error");
                if (d.length)
                    for (var h = 0; h < d.length; h++) d[h].parentNode.removeChild(d[h]);
            ...
            z.prototype.showCallRequest = function(a, c, d, k) {
                ...
                g || (c = this.ifScrollbarDown(), b.chatHandler.webrtcWin && !b.chatHandler.webrtcWin.closed ? b.chatHandler.webrtcWin.focus() : (g = (k = w.agentProfiles[w.profiles[k.urid]]) &&
                    k.pi ? r.agentImgUrl + "/" + k.pi : "default", e = e.replace(/__IMAGE_URL__/, g ? "url('" + g + "');" : "transparent;"), e = e.replace(/__INCOMING_CALL__/, b.languageParser.translate("chat", "incoming_call_message", {
                        name: k.n
                    })), e = e.replace(/__ACCEPT_CALL__/, b.languageParser.translate("chat", "accept_call")).replace(/__DECLINE_CALL__/, b.languageParser.translate("chat", "decline_call")), clearTimeout(this.incomingCallTimeout), g = new C("incoming-call"), g.template = e, g.buildView(), e = this.chatContainer.getElementById("chatContainer"),
            ...
            z.prototype.subscribeCallUpdate = function(a, c) {
                var d, k, f, e, g, h, l, m = this,
                    p = this.chatContainer.documentRef,
                    q = this.callData[a],
                    r = this.ifScrollbarDown();
                q ? d = q.callView : (d = new C(a, null, {
                        className: "webrtcCallContainer messageContainer clearfix"
                    }, null, p), d.template = n.escapeTemplateReplacement(t.callInfo, [{
            ...
            z.prototype.updateCallView = function(a, c) {
                ...
                k.ver > a.ver || (g = this.ifScrollbarDown(), k = k.callView, l = k.elementReferrer.getElementsByClassName("btn-icon")[0], callIconContainerEl = k.elementReferrer.getElementsByClassName("callIconContainer")[0], callIconContainerEl.style.backgroundColor = "#47ca2b", "ringing" === a.stts ? ("v" !== a.cllr.t && this.showCallRequest(a.clid, a.rt, a.so, a.cllr), d =
                    ...
                    null, l), h || f ? (d = f ? b.languageParser.translate("chat", "rejected_call") : b.languageParser.translate("chat", "missed_" + ("v" === a.cllr.t ? "agent" : "visitor")), f = b.languageParser.translate("chat", "call_started_on", {
                    startedOn: e
                })) : (f = n.getTimeDifference(a.so, a.eo), d = b.languageParser.translate("chat", "completed_call"), f = b.languageParser.translate("chat", "call_end_details", {
                    startedOn: e,
                    duration: f
            ...
            z.prototype.toggleGreetingsView = function(a) {
                var c = this.chatContainer.getElementById("chatContainer"),
                    d = this.chatContainer.getElementById("greetingsMainContainer"),
                    k = Math.floor(c.scrollHeight),
            ...
            M.prototype.openForm = function(a) {
                ...
                if (l && this.currentForm !== a && h) {
                    ...
                    b.viewHandler.chatContainer.attachUserEventListener(a, function(a) {
                            var b, c = Math.ceil(d.scrollHeight),
                                f = Math.ceil(d.clientHeight);
            ...
            M.prototype.handleResizeofForm = function(a) {
                if (!(y || f.isPopup || f.isEmbedded))
                    if (!b.formHandler.currentForm || a) b.viewHandler.chatContainer.restyle("height", f.maximizedDimensions().height + "px !important");
                    else {
            ...
            M.prototype.attachEventListeners = function() {
                var a, c, d = this,
                    ...
                    n = "preChatForm" === d.formView.elementId,
                    m = "offlineForm" === d.formView.elementId,
                    p = "formcancelclick",
                    q = "formsubmitclick";
                ...
                if (this.formView) return a = this.formView.formData.fields || [], this.formView.formData.dynamicFields && (a = this.formView.formData.dynamicFields), a.forEach(function(a) {
                    ...
                    if ("additionalQuestion" ===
                        ...
                        formLabelEl = e.parentElement.parentElement.getElementsByClassName("form-field-label")[0], errorIconEl = b.viewHandler.chatContainer.getElementById(a.fieldName + "FieldErrorIcon"), m = "choice" === a.fieldType ? f.getSelectedCheckbox(m, a.isRequired) : f.getSelectedRadio(m, a.isRequired), h.innerHTML = "", h.style.display = "none", errorIconEl.style.display = "none", e.className = e.className.replace("error", ""), null === m ? (k++, l = !1, h.innerHTML = b.languageParser.translate("form", a.languageKey + "ErrorMessage"), h.style.display = "block",
                            errorIconEl.style.display = "block", e.className += " error", formLabelEl.style.color = "#e52f48") : (formLabelEl.style.color = "#707070", d[a.fieldName] = m);
                    else {
            ...
            M.prototype.getSelectedRadio = function(a, b) {
                for (var d = "", k = 0, f = a.length; k < f; k++)
                    if (a[k].checked) {
                        d =
                            a[k].value;
                        break
                ...
                a.forEach(function(a, d) {
                    ...
                    if ("name" !== a.fieldType && "email" !== a.fieldType && "department" !== a.fieldType)
                        if ("choice" === a.fieldType || "option" === a.fieldType) {
                            ...
                            for (var f = 0, e = k.length; f < e; f++) k[f].checked = !1
            ...
            K.prototype.calculateBubblePositioning = function(a, b, d, k, e, g, h) {
                var l = f.minimizedDimensions().width,
                    m = {};
            ...
            K.prototype.calculateIndicatorPositioning = function() {
                var a = {},
                    ...
                    d = this.indicatorHeight,
                    k = f.minimizedDimensions().width,
                    e = f.minimizedDimensions().height,
                    h = "";
            ...
            var Fa = K.extend({
                ...
                createCanvasChatBubble: function() {
                    var a, b, d,
                        k, e, g, h, l, m, n, p, q, r, t, v, x, u, w = 5,
                        y = f.chatBubble().bgc;
            ...
            var W = TawkClass.extend({
                init: function(a, c) {
                    ...
                    D.name.subscribe(function() {
                        if (!n.isGeneratedName(D.name()))
                            for (var a = n.getElementsByClassName(d.container.documentRef, "messageOwnerName visitor"), b = 0; b < a.length; b++) a[b].style.display = "none"
                    });
                ...
                toggleUploadsAction: function() {
                    var a =
                        this,
                        c = this.container.getElementById("uploadFileOption");
                    c && (f.showUploads() ? (c.style.display = "block", this.container.attachUserEventListener("change", function(c) {
                            b.eventHandler.cancelEvent(c);
                            a.closeMenu();
                            c = b.eventHandler.getTargetElement(c).files;
                ...
                toggleRatingAction: function() {
                    var a =
                        this.container.getElementById("rateMainWrapper"),
                        c = this.container.getElementById("rateContainer");
                ...
                attachEvents: function() {
                    ...
                    this.container.attachUserEventListener(b.viewHandler.clickEvent, function(a) {
                        var c =
                            b.eventHandler.getTargetElement(a); - 1 !== c.className.indexOf("messageOwnerName") && -1 !== c.className.indexOf("visitor") && (b.formHandler.openForm("nameForm"), b.eventHandler.cancelEvent(a))
                    ...
                    this.container.attachUserEventListener(b.viewHandler.clickEvent, function() {
                            var b = a.container.getElementById("chatMenu"),
                                c = a.container.getElementById("chatMenuControls");
                ...
                toggleSound: function() {
                    var a =
                        this.container.getElementById("soundOn"),
            ...
            W.prototype.resizeTextArea = function() {
                ...
                this.resizeThrottle = setTimeout(function() {
                    var c = a.chatTextarea.elementReferrer.value,
                        d = a.container.documentRef.getElementById("textareaContainer"),
            ...
            var pa = W.extend({
                init: function() {
                    ...
                    b.eventEmitter.on("formClosed", function() {
                        ...
                        if (c)
                            if (f.showPreChatForm && !r.prechatFormSubmitted()) b.formHandler.openForm("preChatForm");
                            else if (a.setChatGreetings(!0), c.style.display = "block", a.wrapper.removeClass("noMenu"),
                ...
                attachEvents: function() {
                    ...
                    this.container.attachUserEventListener(b.viewHandler.clickEvent, function(a) {
                        f.whiteLabel() || (f.brandingRedirect() ? g.open("https://risksys.co.ke/risksys/") : c.style.display = "block")
                    ...
                    this.container.attachUserEventListener(b.viewHandler.clickEvent, function(a) {
                        c.style.display = "none";
                        g.open("https://risksys.co.ke/risksys/")
            ...
            var F = z.extend({
                init: function() {
                    ...
                    if (!f.isPopup &&
                        !f.isEmbedded) {
                        p = new Fa;
                        var c = [p.container, p.chatIndicator, p.bubbleContainer, this.overlayElement],
                            d;
                        ...
                        ]) : d.concat([this.resizeTopRight, this.resizeBottomRight])) : f.isTopPositioned() ? (d.push(this.resizeFromBottom), f.isRightPositioned() ? d.push(this.resizeBottomLeft) : d.push(this.resizeBottomRight)) : (d.push(this.resizeFromTop), f.isRightPositioned() ? d.push(this.resizeTopLeft) : d.push(this.resizeTopRight)));
            ...
            F.prototype.calculateWidgetPosition = function() {
                var a, b, d = Math.max((document.documentElement.clientHeight,
                        g.innerHeight || 0) / 2) - f.maximizedDimensions().height / 2,
                    e = {};
            ...
            F.prototype.insertPopupStyle =
                function() {
                    var a = document.getElementsByTagName("head")[0],
                        ...
                        d = n.createElement(document, "style", {
                            type: "text/css"
                        }),
                        e;
            ...
            F.prototype.begin = function() {
                var a = this,
                    c = document.getElementById(l.embedded),
                    d;
            ...
            F.prototype.setResizedDimensions = function(a, c, d) {
                var e, g = this.iframeContainer.elementReferrer,
            ...
            F.prototype.onWindowResizeTimeout = function() {
                var a = this.getActualViewportDimensions(),
                    ...
                    h = parseInt(e.frameWidth.replace("px", ""), 10),
                    l = parseInt(e.frameHeight.replace("px", ""), 10);
            ...
            Z.prototype.startRegister = function() {
                var a = ea.getHTTPCookie("TawkConnectionTime"),
            ...
            U.prototype.getDeparmentOptions = function() {
                var a, c, d, f = [],
                    e = r.departments;
                e.sort(function(a, b) {
                    var c = n.rawDecode(a.n).toLowerCase(),
                        d = n.rawDecode(b.n).toLowerCase();
            ...
            U.prototype.getDeparmentName = function(a) {
                ...
                for (d = f.length; b < d; b++)
                    if (f[b].did === a) return n.rawDecode(f[b].n);
                return a
            };
            ...
            U.prototype.formatPrechatData = function(a, c) {
                var d = this,
                    f = this.formatFormData(a, m.getPrechatFields());
            ...
            U.prototype.handlePrechatSave = function(a, c) {
                ...
                if (0 < a.questions.length)
                    for (d = 0, f = a.questions.length; d < f; d++) e += n.rawDecode(a.questions[d].label) + " : " + a.questions[d].answer, d !== f - 1 && (e += "\r\n");
            ...
            U.prototype.visitorChatDismiss = function(a) {
                var c;
                b.chatHandler.messages && (c = Object.keys(b.chatHandler.messages), c = c[c.length - 1], (c = b.chatHandler.messages[c]) && c.co && (c = (new Date(c.co)).getTime(), b.socketManager.sendToConnector("visitorChatDismiss", {
                    timestamp: c
                }, function(b) {
                    if (b) return a(b);
                    a(null)
            ...
            J.prototype.handleMessageFromServer = function(a) {
                ...
                "WEBRTC_CALL" === a.m && a.md && a.md.webrtc ? this.hasWebRTCall = !0 : "CHAT_ENDED" !== a.m || this.hasChatEnded ? ("v" ===
                    a.ut && "c" === a.t && b.viewHandler.addWaitTime(), f.isPopup || ("c" !== a.t || b.viewHandler.isMaximized || "v" === a.ut || f.isEmbedded || !y) || (b.viewHandler.hasChatStarted = !0), w.chatVersion = a.cver, "s" === a.ut || ("c" !== a.t || this.hasChatStarted()) || (this.hasChatStarted(!0), l.triggerApiHandlers("onChatStarted", {
                        chatId: w.chatId
                    })), "c" === a.t ? "a" === a.ut ? a.md && a.md.file ? l.triggerApiHandlers("onFileUpload", "https://tawkto.link/" + a.md.file.name) : l.triggerApiHandlers("onChatMessageAgent", a.m) : "s" === a.ut && l.triggerApiHandlers("onChatMessageSystem",
            ...
            J.prototype.sendMessageToServer = function(a, c, d) {
                ...
                b.socketManager.sendToConnector("sendChatMessage", a, function(b, g, h) {
                    b || (e = ++w.chatOrder, f.messages[e] = {
                        ...
                        messageId: c,
                        uid: D.visitorId
                    }, w.chatVersion = h, f.hasChatStarted() || "offline" === r.pageStatus() || (f.hasChatStarted(!0), l.triggerApiHandlers("onChatStarted", {
                        chatId: w.chatId
            ...
            J.prototype.getMessageObjectById = function(a) {
                var b = null,
                    d;
                for (d in this.messages)
                    if (this.messages[d].messageId === a) {
                        b = this.messages[d];
                        break
                    } return b
            };
            ...
            sa.prototype.addAgentToList = function(a, c, d, f) {
                var e = w.agents[d];
                if (e)
                    if (e.seq.time < a.seq.time || e.seq.time === a.seq.time && e.seq.inc < a.seq.inc) {
                        e.seq = a.seq;
                ...
                else w.agents[d] = a, w.profiles[d] = a.pid;
                if (!a.pid) return !1;
            ...
            za.prototype.translate = function(a, b, d, e) {
                ...
                if (0 < g)
                    for (a = 0; a < g; a++) f = f.replace(RegExp("#" + e.vars[a], "g"), this.escapeStringReplacePlacement(d[e.vars[a]]));
                return f
            };
            ...
            if (q) q.handleError(Aa.message, "tawk.js", Aa.lineNumber || Aa.line, Aa.stack);
