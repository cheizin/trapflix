...
?>
<li class="menu-item">
<a href="<?php echo $row['name']; ?>.php"><?php echo $row['name']; ?></a>
</li>
<?php
               }
               ?>
...
<?php echo $_SESSION['name'];?>
   ...
   <div class="video-container iq-main-slider">
      <video class="video d-block" controls loop>
         <source src="video/Otile Brown X Jovial - Such Kinda Love (Official Music Video)sms skiza 7301722 to 811.mp4" type="video/mp4">
      </video>
   </div>
   <!-- Banner End -->
