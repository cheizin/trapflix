...
{?>
  ...
  $video_name = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM videos WHERE id ='".$row['video_id']."'"));
   ?>
            <div class="slide slick-bg s-bg-<?php echo $video_name['banner_css'] ;?>">
                     ...
                     <div class="row align-items-center  h-100">
                        <div class="col-xl-6 col-lg-12 col-md-12">
                           ...
                           <h1 class="slider-text big-title title text-uppercase" data-animation-in="fadeInLeft"
                              data-delay-in="0.6"><?php echo $video_name['title'] ;?></h1>
 ...
 <a onclick="Selectbanner('<?php echo $video_name['token'];?>');">
                                             </form>
                           </div>
                        </div>
                     </div>
                     <div class="trailor-video">
                        <a href="video/<?php echo $video_name['videoname'] ;?>" class="video-open playbtn">
                       ...
                       <div class="row">
                        ...
                        <!--   <ul class="favorites-slider2 list-inline  row p-0 mb-0"> -->
                               <ul class="favorites-slider2 list-inline  row p-0 mb-0">
                                  ...
                                  <?php
                          $sql_query123 =  mysqli_query($dbc,"SELECT * FROM popular_videos WHERE is_popular = 'yes'  ");
                          ...
                          {?>
                                  <?php
                                  $no = 1;
                                   $sql3 = mysqli_query($dbc,"SELECT * FROM popular_videos WHERE is_popular = 'yes' " );
         ...
         <a onclick="Selectvideos2('<?php echo $video_name['token'];?>');">
          ...
          <a onclick="Selectvideos('<?php echo $video_name['token'];?>');">
                                         ...
                                         <div class="block-images position-relative">
                                            <div class="img-box">
                                               <img src="images/favorite/<?php echo $video_name['thumbnail']; ?>" width="200" height="250" alt="">
                                            </div>
...
<!-- end popular list -->
        ...
        <?php
$sql_query1 =  mysqli_query($dbc,"SELECT * FROM major_channels WHERE is_top_channel ='yes' ORDER BY id");
...
{?>
  ...
  <?php
  $no = 1;
   $sql2 = mysqli_query($dbc,"SELECT * FROM major_channels WHERE is_top_channel ='yes' ORDER BY id ASC");
   while($row2 = mysqli_fetch_array($sql2)){

     $channel_name = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM main_categories WHERE id ='".$row2['category_id']."'"));
     $sql_query1234 =  mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$channel_name['category_name']."'  ");
         ...
         <section id="iq-favorites">
            <div class="container-fluid">
               <div class="row">
                  <div class="col-sm-12 overflow-hidden">
                     <div class="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 class="main-title"><?php echo $channel_name['category_name']; ?>
                             <img src="images/favorite/<?php echo $row2['verified']; ?>" width="25" height="25" alt=""></h4>
...
{?>
  ...
  <?php
  $no = 1;
   $sql2 = mysqli_query($dbc,"SELECT * FROM main_categories WHERE category_name !='Popular On Trapflix'  ORDER BY id ASC");
   while($row2 = mysqli_fetch_array($sql2)){

     $sql_query1234 =  mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$row2['category_name']."'  ");
