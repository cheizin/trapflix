...
$video_name = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM videos WHERE token ='".$_GET['token']."'"));
   ...
   <div class="col-lg-12">
      <div class="trending-info g-border">
        ...
        <form id="add-job-seeker-form2" class="mt-4" enctype="multipart/form-data">
          <input type="hidden" value="order-video" name="order-video">
 ...
 <br/>
   ...
   <div class="main-content movi">
      <section class="movie-detail container-fluid">
         ...
         <?php
         $get_channel = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM videos WHERE token ='".$_GET['token']."'"));
         $no = 1;
          $sql2 = mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$get_channel['title']."' ORDER BY order_id ASC ");
