...
if(!isset($_SESSION['email']))
{
      ...
      ?>
<script>
  window.location.href = "https://trapflix.risksys.co.ke/";
  </script>
...
<!-- end popular list -->
        ...
        <?php
$sql_query1 =  mysqli_query($dbc,"SELECT * FROM major_channels  ORDER BY order_id");
...
{?>
  ...
  $no = 1;
   ...
   while($row2 = mysqli_fetch_array($sql2)){
     ...
     $sql_query1234 =  mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$channel_name['category_name']."' ORDER BY order_id ASC");
               ...
               <div class="row">
                  <div class="col-sm-12 overflow-hidden">
                     <div class="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 class="main-title" ata-toggle="tooltip"  title="This is a premium verified Channel account"><?php echo $channel_name['category_name']; ?>
                             <img src="images/favoriteCompressed/<?php echo $row2['verified']; ?>" loading="lazy" data-toggle="tooltip"  title="This is a premium verified Channel account" width="25" height="25" alt=""></h4>
                ...
                <!--   <ul class="favorites-slider2 list-inline  row p-0 mb-0"> -->
                       <ul class="favorites-slider list-inline  row p-0 mb-0">
                          ...
                          <?php
                  $sql_query123 =  mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$channel_name['category_name']."' ORDER BY order_id ASC");
                  ...
                  {?>
                          <?php
                          $no = 1;
                           $sql3 = mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$channel_name['category_name']."' ORDER BY order_id ASC" );
                           while($row3 = mysqli_fetch_array($sql3)){
                           ?>
                           <li class="slide-item">
                             <form method="post" action="movie-details.php">
                               ...
                               <?php
      $youtube_name = mysqli_query($dbc,"SELECT * FROM videos WHERE id ='".$row3['id']."' && youtube_vid ='youtube' ORDER BY order_id ASC") or die(mysqli_error($dbc));
            ...
            <div class="block-space">
               <div class="row">
                  ...
                  <div class="col-lg-3 col-md-4">
                           ...
                           <div class="col-lg-3 col-md-4">
    <strong> <a href="#"  data-toggle="modal" data-target="#rating-user-modal"> Copyright &copy; <?php echo date("Y");?>TRAPFLIX    All rights reserved.</a></strong>
