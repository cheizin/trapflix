...
//end check subscription
    ...
    ?>
      ...
      <a onclick="Selectbanner2('<?php echo $video_name['token'];?>');" class="btn btn-hover" title="Click Here to Play Video">Play Now </a>
                              ...
                              <div class="col-xl-6 col-lg-12 col-md-12">
    <img src="images/favorite/<?php echo $video_name['thumbnail'];?>" loading="lazy" width="500" height="500">
                              </div>
                           </div>
                       ...
                       <div class="row">
                        ...
                        <!--   <ul class="favorites-slider2 list-inline  row p-0 mb-0"> -->
                          ...
                          {?>
                                  <?php
                                  $no = 1;
                                   $sql3 = mysqli_query($dbc,"SELECT * FROM popular_videos ORDER BY id DESC LIMIT 8" );
                                   while($row3 = mysqli_fetch_array($sql3)){
                                      $video_name = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM videos WHERE id ='".$row3['popular_video_id']."' ORDER BY id DESC LIMIT 8"));
                                   ?>
                                   <li class="slide-item">
         ...
         <a onclick="Selectvideos2('<?php echo $video_name['token'];?>');">
          ...
          <a onclick="Selectvideos('<?php echo $video_name['token'];?>');">
                                         ...
                                         <div class="block-images position-relative">
                                            <div class="img-box">
                                               <img src="images/favorite/<?php echo $video_name['thumbnail']; ?>" loading="lazy" width="100%" height="100%" alt="">
                                            </div>
...
{?>
  ...
  $no = 1;
   ...
   while($row2 = mysqli_fetch_array($sql2)){
     ...
     $sql_query1234 =  mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$channel_name['category_name']."' ORDER BY id DESC limit 8 ");
                  ...
                  <div class="col-sm-12 overflow-hidden">
                     <div class="iq-main-header d-flex align-items-center justify-content-between">
                        <h4 class="main-title" ata-toggle="tooltip"  title="This is a premium verified Channel account"><?php echo $channel_name['category_name']; ?>
                             <img src="images/favorite/<?php echo $row2['verified']; ?>" loading="lazy" data-toggle="tooltip"  title="This is a premium verified Channel account" width="25" height="25" alt=""></h4>
 ...
 <a onclick="Selectvideos2('<?php echo $row3['token'];?>');">
  ...
  <a onclick="Selectvideos('<?php echo $row3['token'];?>');">
                                 ...
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                       <img src="images/favorite/<?php echo $row3['thumbnail']; ?>" loading="lazy" width="100%" height="100%" alt="">
...
<?php
$sql_query1 =  mysqli_query($dbc,"SELECT * FROM main_categories WHERE category_name !='Popular On Trapflix' && approved ='yes' ORDER by id desc ");
...
$sql_query1234 =  mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$row2['category_name']."' ORDER BY id DESC LIMIT 8 ");
               ...
               <div class="row">
                ...
                <!--   <ul class="favorites-slider2 list-inline  row p-0 mb-0"> -->
                       <ul class="favorites-slider list-inline  row p-0 mb-0">
                          ...
                          <?php
                  $sql_query123 =  mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$row2['category_name']."' ORDER BY id DESC limit 8 ");
                  ...
                  {?>
                          <?php
                          $no = 1;
                           $sql3 = mysqli_query($dbc,"SELECT * FROM videos WHERE title ='".$row2['category_name']."' ORDER BY id DESC limit 8" );
                           while($row3 = mysqli_fetch_array($sql3)){
                           ?>
                           <li class="slide-item">
                             <form method="post" action="movie-details.php">
  ...
  <a onclick="Selectvideos('<?php echo $row3['token'];?>');">
                                 ...
                                 <div class="block-images position-relative">
                                    <div class="img-box">
                                         ...
                                         <img class="lazy" data-src="images/favorite/<?php echo $row3['thumbnail']; ?>" /  width="100%" height="100%" alt="">
                                    </div>
                                    <div class="block-description">
                                       <h4><?php echo $row3['textname']; ?></h4>
                                       <div class="hover-buttons">
