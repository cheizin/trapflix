        ...
        {?>
                 ...
                 <section id="iq-favorites"  class="iq-main-slider p-0">
                    <div class="container-fluid slide">
                       <div class="row">
                          ...
                          <ul class="favorites-slider3 list-inline  row p-0 mb-0">
                          <!--      <ul class="favorites-slider list-inline  row p-0 mb-0"> -->

                                  <?php
                          $sql_query123 =  mysqli_query($dbc,"SELECT * FROM feeds ORDER BY id DESC");
          ...
          <a onclick="Selectvideos('<?php echo $row3['token'];?>');">
                                         ...
                                         <div class="block-images position-relative">
                                            <div class="">
                                               <img src="images/favoriteFeeds/<?php echo $row3['thumbnail']; ?>" loading="lazy" width="250" height="250" alt="">
                                            </div>
