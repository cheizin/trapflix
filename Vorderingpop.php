...
$video_id = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM popular_videos WHERE id ='".$_GET['id']."'"));


$video_name = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM videos WHERE id ='".$video_id['popular_video_id']."'"));
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                       <div class="menu-main-menu-container">
                          ...
                          <ul id="top-menu" class="navbar-nav ml-auto">
                            ...
                            <li class="menu-item">
                               <a href="orderChannel.php">Back To video Ordering</a>
                            </li>
   ...
   <div class="col-lg-12">
      <div class="trending-info g-border">
        ...
        <form id="add-job-seeker-form2" class="mt-4" enctype="multipart/form-data">
          <input type="hidden" value="order-popular-video-pop" name="order-popular-video-pop">

             <input type="hidden" name="id" value="<?php echo $_GET['id'];?>" >
<br/> <br/>
 Selected Video to be ordered:-  <strong> <?php echo $video_name['textname'] ;?> </strong>
 <br/>
           <div class="form-group">

                  <input type="number" autocomplete="off" class="select2 form-control" name="contact" placeholder="Enter Order Number of <?php echo $video_name['textname'] ;?>"  >
           </div>


           <button type="submit" class="btn btn-hover">Update Video Order Number</button>
   ...
   <div class="main-content movi">
      <section class="movie-detail container-fluid">
         ...
         $video_id2 = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM popular_videos"));

         $no = 1;
          $sql2 = mysqli_query($dbc,"SELECT * FROM popular_videos ORDER BY order_id ASC ");
          while($row2 = mysqli_fetch_array($sql2)){


     $vid_details = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM videos WHERE id = '".$row2['popular_video_id']."' ORDER BY id DESC "));
