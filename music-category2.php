                     ...
                     <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="menu-main-menu-container">
                           <ul id="top-menu" class="navbar-nav ml-auto">
                              ...
                              <li class="menu-item">
                                 <a href="music-category.html">Music</a>
                              </li>
                           </ul>
                        </div>
                     </div>
      ...
      <div id="tvshows-slider">
         <div>
            <a href="movie-details.html">
               <div class="shows-img">
                  <img src="images/music/2.jpg" class="w-100" alt="">
         ...
         <div>
            <a href="movie-details.html">
               <div class="shows-img">
                  <img src="images/music/3.jpg" class="w-100" alt="">
                  <div class="shows-content">
   ...
   <section id="music-part">
      <div class="container py-5">
         <div class="row">
                        ...
                        <div class="row">
                           <div class="col-sm-12 overflow-hidden">
                              <div class="iq-main-header d-flex align-items-center justify-content-between">
                                 <h4 class="main-title">All music</h4>
                              </div>
                  ...
                  <section id="iq-suggestede">
                     <div class="container">
                        <div class="row">
                           <div class="col-sm-12 overflow-hidden">
                              <div class="iq-main-header d-flex align-items-center justify-content-between">
                                 <h4 class="main-title">Music We Recommend</h4>
                              </div>
                              <div class="suggestede-contens">
                                 <ul class="list-inline favorites-slider2 row p-0 mb-0">
                                    <li class="slide-item">
                                       <a href="movie-details.html">
                                          <div class="block-images position-relative">
                                             <div class="img-box">
            ...
            <!-- Part-2 -->
            <div class="col-2 pt-4 pl-2 dropdown">
               <h5 class="pt-4 dropdown-toggle">Music</h5>
               <br/>
               <p class="h7 dropdown-toggle">All gender</p>
               <br/>
               <p class="h8"><strong>Music Quick Links</strong></p>
               <br/>
