...
<body style="background:url('images/login2.jpg') ;  background-repeat: no-repeat;
...
<!-- loader END -->
<!-- MainContent -->
<section class="sign-in-page" style="background:url('images/login2.jpg') ;  background-repeat: no-repeat;
  background-size: 100% 100%;">
   <div class="container">
...
$(document).on("submit", "#test-login-form", function(e){
   ...
   alert("Invalid Login Credentials");
          //  Toast.fire({
            ...
            {
                alert('Your account is not verified. Please click on the Verification link below to verify');
