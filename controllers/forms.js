...
function reorderChannel2(str)
{

    var form_id = $('#reorder-channel-form-'+str);

    var channel = $('#channel-'+str).val();

    var reorder_channel = 'reorder_channel';
    ...
    form_data.append('reorder_channel',reorder_channel);

    var form_url = 'controllers/channelManagement/orderChannel.php';
    var form_method = 'POST';
...
$(document).on("submit", "#test-login-form", function(e){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            Toast.fire({
                icon: 'error',
                title: 'Your Account has been Deactivated. Contact System Administrator'
              });
            }
            else
            {
...
$(document).on("submit", "#test-login-form2", function(e){
    e.preventDefault();

    var process_url = 'controllers/auth/TestLoginController.php';
    var form_data = $('#test-login-form2').serializeArray();
    var form_method = 'POST';
...
//END LOGIN FORM
// Send mail notification for email validation and confirmation
$(document).on("submit","#enter_email_form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/password-validation/password_validation_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              Swal.fire({
                 icon: 'success',
                 title: 'Mail sent check your Email for Password Recovery instruction'
                });
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#enter_email_form').serializeArray(),
                  type: "post",
                  url: "controllers/password-validation/password_mailing.php",
            ...
            else if(data == 'duplicate')
              {
                ...
                Swal.fire({
                     icon: 'error',
                     title: 'The user is not Registered in the system'
                    });
                  // Restore the button text
                  btn.textContent = btn.getAttribute('data-original');
            ...
            btn.removeAttribute('data-original');
              ...
              else if(data == 'failed')
                {
                  Toast.fire({
                     icon: 'error',
                     title: 'Failed to add User Data. Please contact System Administrator'
                    });
                    // Restore the button text
                    btn.textContent = btn.getAttribute('data-original');
...
// subscription Email
$(document).on("submit","#subcription_email_form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/subscription/subcription_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              Swal.fire({
                 icon: 'success',
                 title: 'You Have Successfully Subscribed to our New Letter Updates'
                });
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#subcription_email_form').serializeArray(),
                  type: "post",
                  url: "controllers/subscription/subcription_mailing_controller.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
            ...
            else if(data == 'duplicate')
              {
                ...
                Swal.fire({
                     icon: 'error',
                     title: 'The user is already Subscribed for the News Letter in the system'
                    });
                  // Restore the button text
                  btn.textContent = btn.getAttribute('data-original');
...
//Register job Seeker
$(document).on("submit","#add-job-seeker-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');


    var form_data = $(this).serializeArray();
    var form_url = 'controllers/trapuser/registercontroller.php';
    var form_method = 'POST';
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-job-seeker-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/job-seeker-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
            ...
            else if(data == 'duplicate')
              {
                ...
                Swal.fire({
                   icon: 'error',
                   title: 'The user is Already Registered in the system'
                  });
                  // Restore the button text
                  btn.textContent = btn.getAttribute('data-original');
...
//Register recruiter
$(document).on("submit","#add-recruiter-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');

    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              // Update the button text
              btn.textContent = 'Submitting Company Details...';
              Toast.fire({
                 icon: 'success',
                 title: 'Company Information Successfully Registered'
                });

                $('#add-recruiter-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
//  $('.test-login-link">').click();
  window.location.href = "login.php";
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-recruiter-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
                        ...
                        else if(data == 'duplicate')
                          {
                            ...
                            Toast.fire({
                               icon: 'error',
                               title: 'The Company is Already Registered in the system'
                              });
                              // Restore the button text
                              btn.textContent = btn.getAttribute('data-original');
...
$(document).on("submit","#add-recruiter-form-referral", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              Toast.fire({
                 icon: 'success',
                 title: 'Company Information Successfully Registered Through referral'
                });
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-recruiter-form-referral').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/referral-recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
              $.ajax({
                data : $('#add-recruiter-form-referral-notification').serializeArray(),
                type: "post",
                url: "controllers/mailingSystem/referral-recruiter-info-notification.php",
                success: function (mail_data) {
                    console.log(mail_data);
                }
            });
...
// sell a module for Signup

$(document).on("submit","#add-module-sell-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.textContent = 'Submitting Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/admin-portal/sell_module.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Module Successfully Sold'
                });

                $('#sell-a-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
$('.sell-module-link').click();
// location.reload();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-module-sell-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// Employee signup for a companyName

$(document).on("submit","#personal-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.textContent = 'Submitting Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/personell-management/personell_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Employee Personal details Added successfully'
                });
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#personal-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/personell-management/mailing.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
// Trainee details form_method
$(document).on("submit","#training-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.textContent = 'Submitting Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/training-management/trainee_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Trainee details Added successfully'
                });
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#training-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// trainer Details
$(document).on("submit","#trainer-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Trainer Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/training-management/trainee_controller.php';
    var form_method = 'POST';
...
$(document).on("submit","#all_candidates_form", function (e){
e.preventDefault();

  var form_data = $(this).serializeArray();
  var target_url  = 'views/reports/fetch_all_candidates.php';
  var form_method = 'POST';
...
// assign course to a trainers

$(document).on("submit","#course-trainers-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Course assigned successfully to a trainee'
                });
...
//Whole budget amount
$(document).on("submit","#whole-budget-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Budget...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/training-management/trainee_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Total Budget Information Added'
                });
...
// individual budget listen
$(document).on("submit","#individual-budget-list-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Individual Budget...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/training-management/trainee_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Individual Budget Added'
                });

                $('#add-individual-budget-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
$('.budget-tab').click();
// location.reload();
...
// training managemenet listen
$(document).on("submit","#trainee-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#trainee-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
        ...
        $.ajax({
            ...
            success:function(data){
              ...
              if(data == "success")
              {
                Swal.fire(
                  status_label,
                  'User ' +status_label+ ' Successfully',
                  'success'
                );
                $('.personell-link').click();
...
else
{
  ...
  Swal.fire({
      title: 'The leave will be MARKED as ' + status,
      text: "Are you sure to proceed?",
      icon: 'question',
      showCancelButton: true,
      confirmButtonText: 'YES, '+ status_action,
      ...
      if (result.value) {
        ...
        var form_url = 'controllers/leave-management/leave_controller.php';
        var form_method = 'POST';
        ...
        $.ajax({
            ...
            success:function(data){
              ...
              if(data == "success")
              {
                Swal.fire(
                  status_label,
                  'Leave' +status_label+ ' Successfully',
                  'success'
                );
                $('.leave-link').click();
                //ViewProject(project_id);
                ...
                $.ajax({
                      data : mail_data,
                      type: "post",
                      url: "controllers/leave-management/leaveApprovals.php",
                      success: function (mail_data) {
                          console.log(mail_data);
                      }
...
// deactivate trainee_list
// deactivate a user account_no
function  ChangeTrainStatus(id,status) {
if(status == "deactivated")
{
  status_label = "deactivated";
  status_action = "DEACTIVATE";
...
// change course details status_label
...
else
{
  ...
  Swal.fire({
      title: 'The Course will be ' + status,
      text: "Are you sure to proceed?",
      icon: 'question',
      showCancelButton: true,
      confirmButtonText: 'YES, '+ status_action,
        ...
        $.ajax({
            ...
            success:function(data){
              ...
              if(data == "success")
              {
                Swal.fire(
                  status_label,
                  'Course ' +status_label+ ' Successfully',
                  'success'
                );
...
// BANK DETAILS add_request_application
$(document).on("submit","#add-bank-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Bank Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/personell-management/personell_controller.php';
    var form_method = 'POST';
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-bank-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// statutory deductionn add Details

$(document).on("submit","#add-statutory-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Statutory Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/personell-management/personell_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Statutory Details Added successfully'
                });

                $('#add-bank-details-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
$('.statutory-details-tab').click();
// location.reload();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-statutory-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// Add employment details for personnel Module
$(document).on("submit","#add-employment-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Employment Details Added successfully'
                });

                $('#add-employmnet-details-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
$('.employment-details-tab').click();
// location.reload();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-employment-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// add leave management details

$(document).on("submit","#add-leave-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Leave Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/leave-management/leave_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Leave Details Added successfully'
                });
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-leave-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/leave-management/mailing.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
// Leave class MANAGEMENT
$(document).on("submit","#add-leave-class-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Leave Class Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/leave-management/leave_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Leave Class Details Added successfully'
                });

                $('#add-leave-class-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
$('.leave-settings').click();
// location.reload();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-leave-class-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/leave-management/mailing.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
$(document).on("submit","#add-course-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Course Details Added successfully'
                });

                $('add-course-details-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
$('.course-details-tab').click();
// location.reload();
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-course-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// dependants Details
$(document).on("submit","#add-dependants-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Dependants Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/personell-management/personell_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Dependants Details Added successfully'
                });

                $('#add-dependants-details-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
$('.dependants-details-tab').click();
// location.reload();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-dependants-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/recruiter-info-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
//  add professional details form_method
$(document).on("submit","#add-professional-history-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Professional History...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/personell-management/personell_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Professional History Successfully Added'
                });

                $('#add-professional-details-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
//  $('.test-login-link">').click();
$('.professional-details-tab').click();
 //location.reload();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-professional-history-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
// adding academic qualification for company personell_list
$(document).on("submit","#add-academic-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Academic History...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/personell-management/personell_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Academic History Successfully Added'
                });

                $('#add-academic-details-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
//  $('.test-login-link">').click();
$('.academic-details-tab').click();
 //location.reload();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-academic-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// adding certicate and Awards
$(document).on("submit","#add-certificate-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Awards...';
    var form_data = $(this).serializeArray();
      var form_url = 'controllers/personell-management/personell_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Certificate and Awards Successfully Added'
                });

                $('#add-certificate-details-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
$('.certificate-details-tab').click();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-certificate-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// evidence documents for academic documents

$(document).on("submit","#add-evidence-details-form", function(e){
    e.preventDefault();
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Evidence Documents Successfully Added'
                });

                $.ajax({
                  data : $('#add-evidence-details-form').serializeArray(),
                  type: "post",
                ...
                $('#add-evidence-details-modal').modal('hide');
                $('body').removeClass('modal-open');
                $('.modal-backdrop').remove();
                $('.documents-details-tab').click();
...
//Register About Me
$(document).on("submit","#add-about-me", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting About Me...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'About Me Successfully Added'
                });

                $('#add-about-me-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
//  $('.test-login-link">').click();
 location.reload();
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-about-me').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// register response of TeST

$(document).on("submit","#add-test-answer-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.textContent = 'Submitting Response...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Test answer Successfully Added'
                });
...
// register reponse answers
$(document).on("submit","#add-test-answer-form2", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Quiz answer Successfully Added'
                });
...
// Register answers to a TeST


$(document).on("submit","#add-response-answer-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-response-answer-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/process-review-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
$(document).on("submit","#add-response-answer-form2", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// add job title for test postText

$(document).on("submit","#add-job-title-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Assessment Name...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Job Title Successfully Added'
                });

                $('#add-job-modal').modal('hide');
                 $('.create-test-link').click();
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-job-title').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
$(document).on("submit","#add-group-title-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Assessment Group Name...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Asessement Group Successfully Added'
                });
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-group-title-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/assessment-grouping-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
$(document).on("submit","#add-job-title-form2", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Job Test...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Aptitude Test Successfully Added'
                });
...
//post job vaccancy
$(document).on("submit","#add-job-vaccancy-form2", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Job Vaccancy...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                ...
                $('#post-job-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
  window.location.href = "add-job.php";
 //location.reload();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-job-vaccancy-form2').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/add-job-mailing.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
$(document).on("submit","#bulk-email-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.textContent = 'Sending Email...';
  ...
  window.location.href = "bulk_mails.php";
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#bulk-email-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/bulk_mailing.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
$(document).on("submit","#bulk-save-email-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.textContent = 'Saving Email...';
  ...
  window.location.href = "config_mails.php";
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#bulk-save-email-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/bulk_save_mailing.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
function viewJobApplicantss(str)
{
  $('#response-data').html('');
  //destrory any active tooltips
  $('[data-toggle="tooltip"]').tooltip("dispose");

  var form_url = window.location.href = "job-detail.php";
...
//post job vaccancy
$(document).on("submit","#add-test-history-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Test Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
$(document).on("submit","#set-timer-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.setAttribute('data-original', btn.textContent);
// Update the button text
btn.textContent = 'Submitting Timer Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Timer Saved Successfully'
                });
 ...
 //location.reload();
    ...
    btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#set-timer-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/process-timer-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
            ...
            else if(data == 'exist')
              {
                ...
                Swal.fire({
                   icon: 'error',
                   title: 'Assign a job post First Before Setting the Timer'
                  });
                  // Restore the button text
                  btn.textContent = btn.getAttribute('data-original');
...
$(document).on("submit","#add-quiz-history-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Quiz Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/training-management/trainee_controller.php';
    var form_method = 'POST';
...
// Assign test to job postText

$(document).on("submit","#add-job-post-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Assigned Job Post...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Assigning Job To Test Done Successfully'
                });
...
// assigning quiz to a course list
$(document).on("submit","#add-job-post-form2", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Assigned course...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/training-management/trainee_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Assigning course to test Successfully'
                });
...
// Change application status for selected job postText


$(document).on("submit","#add-status-post-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Sending Application request...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-status-post-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/job-applied-status.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
$(document).on("submit","#send-application-request-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
btn.textContent = 'Sending Application request...';
    ...
    $('.modal-backdrop').remove();
 //$('.all-post-vaccancy-link').click();
  window.location.href = "candidates_database.php";
 //location.reload();
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#send-application-request-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/request-to-apply-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
//Applied Job vaccancy

$(document).on("submit","#add-application-details-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Store the original text to a add-application-details-formdata attribute
btn.setAttribute('data-original', btn.textContent);

// Update the button text
btn.textContent = 'Submitting Job Application Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Applied For the Job Successfully'
                });

  window.location.href = "jobs-applied.php";
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-application-details-form').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/apply-for-position.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
//Register Employmwnt History
$(document).on("submit","#add-employment-history-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Employment History...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Employment History Successfully Added'
                });

                $('#add-employment-history-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-employment-history-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// register employment history for personell_list

// add education History

$(document).on("submit","#add-education-history-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Education History...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Education History Successfully Added'
                });

                $('#add-education-history-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
//  $('.test-login-link">').click();
 location.reload();
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-education-history-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
// Add test details for respective job title_name
//start modifying project lesson
function SubmittestHistory(str)
{
    var id = str;
    var form_id = $('#add-test-history-form-'+str);

    var email = $('#email-'+str).val();
    var test_name = $('#test_name-'+str).val();
    ...
    $.ajax({
        ...
        beforeSend:function()
        {
          $.blockUI({ message: blockui_spinner, baseZ: 2000 });
        },
        success:function(data){
            $.unblockUI();
            if(data == 'success')
            ...
            //  SelectProjectModule($.trim( $('.project-lessons-learnt-link').text() ));
              //ViewProject(project_id);
            }
            else if(data == 'failed')
            {
...
//end modifying project lesson

function SubmittestAns(str)
{
    var id = str;
    var form_id = $('#add-test-answer-form-'+str);

    var email = $('#email-'+str).val();
    var test_name = $('#test_name-'+str).val();

    var add_test_answer = 'add_test_answer';
...
// submit individual test_name

//  Request to apply for the position
...
btn.textContent = 'Submitting Request...';
    var id = str;
    var form_id = $('#request-application-form-'+str);
    var post_name = $('#post_name-'+str).val();
    var email = $('#email-'+str).val();
    var special_info = $('#special_info-'+str).val();
  //  var invoice_doc = $('#invoice_doc-'+str).val();
    var add_request_application = 'add_request_application';
    ...
    //  invoice_doc:invoice_doc,
      add_request_application:add_request_application,
    };
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              $('#application-request-modal-'+str).modal('hide');
              $('body').removeClass('modal-open');
              $('.modal-backdrop').remove();
              ...
              $('.all-saved-candidates-link').click();
              // Restore the button text
              btn.textContent = btn.getAttribute('data-original');
...
$(document).on("submit","#add-awards-history-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                ...
                $('#add-awards-history-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
//  $('.test-login-link">').click();
 location.reload();
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-awards-history-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
$(document).on("submit","#add-job-skills-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Skills..';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Job Skills Successfully Added'
                });
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-job-skills-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
$(document).on("submit","#add-competency-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Competency..';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Job Competency Successfully Added'
                });

                $('#add-competency-modal').modal('hide');
    $('body').removeClass('modal-open');
    $('.modal-backdrop').remove();
//  $('.test-login-link">').click();
 location.reload();
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-competency-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
$(document).on("submit","#add-KPI-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting KPI..';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-seeker/job_seeker_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Job KPI Successfully Added'
                });
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#add-KPI-form').serializeArray(),
                  type: "post",
                  url: "controllers/job-seeker/process-send-mail.php",
                  success: function (mail_data) {
                      console.log(mail_data);
...
function loadProfile()
{
              ...
              $('.job-seeker-profile-link').click();


}

function loadRecProfile()
{

              $('.rec-profile-link').click();
...
// attach evidence for course DETAILS

$(document).on("submit","#add-evidence-course-form", function(e){
    e.preventDefault();
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                ...
                $('#evidence-course-modal').modal('hide');
                $('body').removeClass('modal-open');
                $('.modal-backdrop').remove();
                $('.materials-details-tab').click();
...
$(document).on("submit","#all_application_request_form", function (e){
e.preventDefault();

  var form_data = $(this).serializeArray();
  var target_url  = 'views/reports/fetch_all_request.php';
  var form_method = 'POST';
...
$(document).on("submit","#all_jobs_form", function (e){
e.preventDefault();

  var form_data = $(this).serializeArray();
  var target_url  = 'views/reports/fetch_all_jobs.php';
  var form_method = 'POST';
...
$(document).on("submit","#all_pending_test_form", function (e){
e.preventDefault();

  var form_data = $(this).serializeArray();
  var target_url  = 'views/reports/fetch_all_pending_test.php';
  var form_method = 'POST';
...
e.preventDefault();
  ...
  var form_data = $(this).serializeArray();
  var target_url  = 'views/reports/fetch_all_personal_info.php';
  var form_method = 'POST';
...
$(document).on("submit","#all_job_posted_form", function (e){
e.preventDefault();

  var form_data = $(this).serializeArray();
  var target_url  = 'views/reports/fetch_all_job_posted.php';
  var form_method = 'POST';
...
$(document).on("submit","#all_jobs_posted_applied_form", function (e){
e.preventDefault();

  var form_data = $(this).serializeArray();
  var target_url  = 'views/reports/fetch_all_jobs_posted_applied.php';
  var form_method = 'POST';
...
$(document).on("submit","#all_company_info_form", function (e){
e.preventDefault();

  var form_data = $(this).serializeArray();
  var target_url  = 'views/reports/fetch_all_company_info.php';
  var form_method = 'POST';
...
function ModifyProject(str)
{
    ...
    var form_url = 'controllers/edit/questionsEditController.php';
    var form_method = 'POST';
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              $('.modal-backdrop').remove();
               ...
               Toast.fire({
                    icon: 'success',
                    title: 'Questions Modified Successfully'
                  });
...
function CloseProject(id) {
  ...
  Swal.fire({
      title: 'This Question will be removed from the list',
      text: "Are you sure to proceed?",
      icon: 'question',
      showCancelButton: true,
      confirmButtonText: 'YES, Delete',
      ...
      if (result.value) {
        ...
        var form_url = 'controllers/delete/deleteQuestionsController.php';
        var form_method = 'POST';
...
//start close Job Post
function CloseJob(id) {

  Swal.fire({
      title: 'This Job will be removed from the Job list',
      text: "Are you sure to proceed?",
      icon: 'Job Post',
      showCancelButton: true,
      confirmButtonText: 'YES, Delete',
