...
session_start();
 ...
 $referral_email = mysqli_real_escape_string($dbc,strip_tags($_POST['referral_email']));
 ...
 $time_recorded = date('Y/m/d H:i:s');
  ...
  //  $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    ...
    $mail->addAddress("$referral_email");     // Add a recipient
...
Congratulations. You will receive 40% refund on your first purchase through Your Referral to the Company Name: <b>'.$fName.'</b>. The details Registered are:- <br/> </p>
  <table>
    <tr>
