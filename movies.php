...
<body>
         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="trending-info g-border">
                         ...
                         <strong>  <p class="trending-dec w-100 mb-0 text-white"><?php echo $video_post['textname'] ;?></p> </strong>  </br>
   ...
   <div class="main-content movi">
        <section class="movie-detail container-fluid">
        	<div class="row">
        		<div class="col-lg-12 subscription-area">
        			<div class="trending-info g-border">
        				<h1 class="trending-text big-title text-uppercase mt-0"></h1>
        				<ul class="p-0 list-inline d-flex align-items-center movie-content">
        					<li class="text-white">
        						<?php echo $video_post['title'] ;?>
        					</li>
        					<?php
                     ...
                     ?> <strong><?php echo $subsccribe_no;?> &nbsp; </strong> Subscribers
                             ...
                             if($total_rows1 = mysqli_num_rows($sql_query1) > 0)
                             {
                               ?>
        						<form id="subscribe-form" class="mt-4">
                                    	<input type="hidden" value="remove-subscribe" name="add-subscribe">
        				...
        				<ul class="p-0 list-inline d-flex align-items-center movie-content"> </ul>
        			</div>
        		</div>
        	</div>
        </section>
      ...
      <section class="movie-detail container-fluid">
         <div class="row">
            <div class="col-lg-12">
              ...
              <div class="col-lg-12 video_comments">
                <?php
