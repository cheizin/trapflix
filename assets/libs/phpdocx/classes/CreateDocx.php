...
class CreateDocx extends CreateDocument
{
    ...
    {
        /** PHPDOCX trial package**/ /** PHPDOCX trial package**/ /** PHPDOCX trial package**/ /** PHPDOCX trial package**/ /** PHPDOCX trial package**/eval(gzinflate(base64_decode('')));
    }
                ...
                if (isset($value['attributes'])) {
                    foreach ($value['attributes'] as $attribute) {
                        if (isset($attribute['start'])) {
                            ...
                            $query = '//w:abstractNum[@w:abstractNumId = "' . $abstractNumId . '"]/w:lvl[@w:ilvl = "' . $attribute['listLevel'] . '"]/w:start';
                            ...
                            $newNumbering = $newNumberingDOM->saveXML($newNumberingDOM->documentElement);
                        }
                    }
                }
        ...
        if ($type == 'replace') {
            ...
            foreach ($styleNodes as $node) {
                ...
                if ($numIdNode->length > 0) {
                    ...
                    $externalNumbering = $this->getFromZip('word/numbering.xml', 'DOMDocument', $zipStyles);
                    $numXPath = new DOMXPath($externalNumbering);
                    $numXPath->registerNamespace('w', 'http://schemas.openxmlformats.org/wordprocessingml/2006/main');
    ...
    protected function getWordContentByRels($referenceNode = array())
    {
        ...
        if (count($sectPrNodes) > 0) {
            ...
            foreach ($sectPrNodes as $sectPrNode) {
                ...
                $optionEntityLoader = libxml_disable_entity_loader(true);
                $sectionRels->loadXML($sectPrNode->ownerDocument->saveXML($sectPrNode));
                libxml_disable_entity_loader($optionEntityLoader);
    ...
    protected function insertContentToDocumentRels($wordFragment, $domDocument, $source, $target, $refNode, $inlineLocation = false)
    {
        ...
        $newContent = preg_replace('/__[A-Z]+__/', '', $newContent);
