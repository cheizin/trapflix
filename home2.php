...
<html lang="en">
  <head>
    ...
    <title>Trapflix Social Media <?php echo $_SESSION['name'] ; ?></title>
      <!-- title icon -->
    ...
    <div class="header">
      <div class="header__left">
        ...
        <div class="header__input">
          ...
          <input type="text" placeholder="Search Trapflix" />
        </div>
      </div>
...
?>
          ...
          <img
            class="user__avatar"
            src="https://trapflix.com/images/profile/<?php echo $user_image['thumbnail'];?>"
            alt=""
          />
          <?php
          }
          ...
          <img
            class="user__avatar"
            src="https://trapflix.com/images/profile/avatar.png"
            alt=""
          />
